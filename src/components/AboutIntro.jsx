        ...
        <div className="flex flex-col md:flex-row w-full max-w-6xl items-center justify-between gap-10">
          ...
          <div style={{ opacity: contentOpacity, transform: `translateY(${textTranslate}px)`, transition: "transform 0.3s ease-out", }}
            ...
            <div className="text-[16px] sm:text-[18px] leading-relaxed font-poppins tracking-[1px] font-thin space-y-4">
              <p>Hi, I’m Varada, a software developer specializing in Java, SQL, and development, 
                with hands-on experience in building scalable, efficient, and maintainable software systems.</p>

              <p>
                {/* I’m drawn to work that balances logic with emotion.  */}
                My work combines precision, structure, and creativity to bring ideas to life effectively.
                But what excites me the most is the process of solving real problems and the immense joy of seeing it all come together.</p>

              {/* <p>I chase calm in organizing, cooking, and caring for my plants. While I experiment with creative pursuits like 
                painting, photography, and embroidery, I love the process because creating, in any form, makes life lighter.</p> */}

                <p>Outside of coding, I enjoy organizing, cooking, and caring for my plants. 
                  Creative hobbies help me maintain focus and a process-driven mindset.</p>
            </div>
